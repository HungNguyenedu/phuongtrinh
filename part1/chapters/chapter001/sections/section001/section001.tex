\section{Phương trình vô tỉ giải được bằng phương pháp tương đương .}
  \subsection{Phương pháp giải }
    Chuyển vế đổi dấu để hai vế không âm, sau đó bình phương hai vế (ta được phương trình tương đương) để khử căn thức, đưa về phương trình đại số, trong đó: 
      ...
      %                         vidu                                                        %
      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		\input{part1/chapters/chapter001/sections/section001/examp/examp.tex}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %                         Bai tap va huong dan                                        %
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	
	\Opensolutionfile{loigiaichung}[loigiaichung1]
	\vspace*{1cm}
 	\subsection{Bài tập } % (fold)	
		\input{part1/chapters/chapter001/sections/section001/practices/practices.tex}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %                                    huong dan                                        %
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\Closesolutionfile{loigiaichung}	
	\subsection*{Lời giải bài tập }
	\addcontentsline{toc}{subsection}{Lời giải bài tập }
	\markright{Lời giải bài tập }
 	\input{loigiaichung1}
